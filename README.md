...
```sh
dsh plugin --profile web add dsh-plugin-ideas-manager@0.2.5
```
...
```sh
dsh plugin --profile web add github:EiffelBS/dsh-plugin-ideas-manager#v0.2.5
```
...
`version` field; releases are tagged, e.g. `v0.2.5`):
