	...
	factory: (require) => {
		...
		*/
		const fr = {
			...
			"new.modelHint": "Modèle de la session qui analyse l'idée : choisissez d'abord le provider, filtrez, puis le modèle (laisser vide = défaut de la session)",
		...
		const en = {
			...
			"new.modelHint": "Model of the session that analyzes the idea: pick the provider first, filter, then the model (empty = session default)",
...
`;
		...
		*  restore), so the author can move an idea without leaving the editor. */
		function IdeaModal({ client, initial, initialWorkspace, onClose, onFollowUp }) {
			...
			(0, import_react.useEffect)(() => {
				let cancelled = false;
				if (client.sessionLauncher === void 0) return;
				client.sessionLauncher.listModels().then((choices) => {
					if (cancelled) return;
			...
			const selectedModel = filteredModelChoices.find((choice) => choice.label === selModelKey) ?? activeProviderChoices.find((choice) => choice.label === selModelKey);
			(0, import_react.useEffect)(() => {
				if (activeProviderChoices.length === 0) return;
				if (!activeProviderChoices.some((choice) => choice.label === selModelKey)) setSelModelKey(activeProviderChoices[0].label);
			}, [
				selProvider,
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						...
						aiMode && modelChoices.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: classes.field,
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									className: classes.fieldLabel,
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
											...
											children: modelProviders.map((provider) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: provider,
												children: provider
											}, provider))
										}),
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("select", {
											...
											disabled: client.pending,
											onChange: (event) => {
												setSelModelKey(event.target.value);
											},
											children: filteredModelChoices.map((choice) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: choice.label,
		...
		function IdeasBoard({ client }) {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					knownTags.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							knownTags.map((name) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
							...
							tagFilter.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								type: "button",
								className: classes.ghostButton,
								onClick: () => {
									setTagFilter([]);
		...
		*/
		function resolveActiveWorkspaceSource(ctx) {
			try {
				const sessions = ctx.get(SESSIONS_SERVICE$1);
			...
			try {
				...
				return {
					launch: async (input) => {
						...
						if (session === void 0) throw new Error("session-face-unavailable");
						if ((await session.prompt([{
							type: "text",
							text: buildAnalysisPrompt(input, pageOrigin())
						}], "queue")).ok !== true) throw new Error("session-prompt-rejected");
