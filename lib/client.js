...
`;
		...
		*/
		...
		function IdeaModal({ client, initial, onClose }) {
			...
			const [value, setValue] = (0, import_react.useState)(initial?.value === void 0 ? "" : String(initial.value));
			const [effort, setEffort] = (0, import_react.useState)(initial?.effort === void 0 ? "" : String(initial.effort));
			const [tags, setTags] = (0, import_react.useState)(tagsText(initial));
			const [error, setError] = (0, import_react.useState)(void 0);
			const toNumber = (raw) => {
				const parsed = Number(raw);
				return raw.trim() === "" ? void 0 : Number.isFinite(parsed) ? parsed : void 0;
			};
				...
				try {
					if (initial === void 0) await client.createIdea({
						...
						const patch = {
							title: title.trim(),
							body: body.trim(),
							...toNumber(value) === void 0 ? {} : { value: toNumber(value) },
							...toNumber(effort) === void 0 ? {} : { effort: toNumber(effort) },
							tags: tags.split(",")
						};
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									className: classes.fieldLabel,
									htmlFor: "dsh-ideas-value",
									children: t("new.value")
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
									id: "dsh-ideas-value",
									className: classes.input,
									type: "number",
						...
						children: IDEA_COLUMNS.map((status) => {
							...
							return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: columnIdeas.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
										...
										return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
												...
												children: [
													...
													idea.body.trim() !== "" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
													...
													(idea.value !== void 0 || idea.effort !== void 0) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
														...
														children: [idea.value !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															...
															children: t("card.value", { value: idea.value })
														}), idea.effort !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
															className: classes.score,
															children: t("card.effort", { effort: idea.effort })
														})]
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
