	...
	factory: (require) => {
		...
		*/
		const fr = {
			...
			"priorities.hint": "Classement suggéré du backlog ouvert — utilisez les flèches ou glissez-déposez pour ajuster",
			...
			"new.rankHint": "Inscrit une opinion de priorité et réordonne transactionnellement le backlog ouvert (triage)",
			"new.rankInvalid": "Le rang doit être un entier positif (1 = premier du backlog ouvert)",
			"new.value": "Valeur",
			"new.effort": "Effort",
		...
		const DICTIONARIES = {
			...
			en: {
				...
				"priorities.hint": "Suggested ranking of the open backlog — use the arrows or drag to adjust",
...
`;
		...
		*/
		function archivedIdeasOf(ideas, workspaceId) {
			return ideas.filter((idea) => idea.status === "archived" && (workspaceId === "" || idea.workspaceId === workspaceId));
		}
		//#endregion
		...
		*/
		...
		function PrioritiesView({ client, openIdeas, allIdeas, workspaceTitle, onEdit, mdMode }) {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					onDrop: dropAtEnd,
					children: ranked.map((idea, index) => {
						const first = index === 0;
		...
		function DeliveredView({ client, archivedIdeas, workspaceTitle, onEdit, mdMode }) {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										...
										(workspaceId !== void 0 || idea.value !== void 0 || idea.effort !== void 0) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: classes.cardMeta,
											children: [
		...
		*  empty; the triage verb is the only path that re-ranks with a shift). */
		function currentOpenRank(idea, ideas) {
			...
			const at = orderIdeas(ideas.filter((item) => item.status === "open")).findIndex((item) => item.id === idea.id);
		...
		*  restore), so the author can move an idea without leaving the editor. */
		function IdeaModal({ client, initial, initialWorkspace, onClose, onFollowUp }) {
			...
			const [workspace, setWorkspace] = (0, import_react.useState)((() => initial?.workspaceId ?? (initialWorkspace === void 0 || initialWorkspace === "" ? sessionWorkspace : initialWorkspace) ?? "")());
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(LevelSelect, {
								id: "dsh-ideas-value",
								label: t("new.value"),
								value: valueLevel,
						...
						(initial === void 0 || initial.status === "open") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: classes.field,
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
									className: classes.fieldLabel,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								disabled: client.pending,
								children: initial === void 0 ? t("new.submit") : t("edit.save")
							})]
						})
					]
				})
		...
		*/
		...
		function IdeasBoard({ client }) {
			...
			const visible = ideas.filter((idea) => (workspaceFilter === "" || idea.workspaceId === workspaceFilter) && matchesFilter(idea, filter) && matchesTags(idea, tagFilter));
			const scopedOpen = ideas.filter((idea) => idea.status === "open" && (workspaceFilter === "" || idea.workspaceId === workspaceFilter));
			const archivedIdeas = archivedIdeasOf(ideas, workspaceFilter);
			const byStatus = (status) => orderIdeas(visible.filter((idea) => idea.status === status));
		...
		*/
		const inject = [WORKSPACES_SERVICE, SESSIONS_SERVICE];
		let claimed = false;
		const releaseClaim = () => {
			claimed = false;
		};
