	...
	factory: (require) => {
		...
		*/
		const fr = {
			...
			"priorities.hint": "Classement suggéré du backlog ouvert — utilisez les flèches pour ajuster",
		...
		const DICTIONARIES = {
			...
			en: {
				...
				"priorities.hint": "Suggested ranking of the open backlog — use the arrows to adjust",
...
`;
		...
		*/
		...
		function PrioritiesView({ client, openIdeas, allIdeas, workspaceTitle, onEdit }) {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						...
						children: [
							...
							activeTab === "overview" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
