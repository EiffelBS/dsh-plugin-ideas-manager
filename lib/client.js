			...
			async triageIdea(ideaId, patch) {
				await this.run({
					...
					patch: {
						...patch.value === void 0 ? {} : { value: patch.value },
						...patch.effort === void 0 ? {} : { effort: patch.effort },
						...patch.rationale === void 0 || patch.rationale === "" ? {} : { rationale: patch.rationale },
...
`;
		...
		*/
		...
		function PrioritiesView({ client, openIdeas, allIdeas, workspaceTitle, onEdit, mdMode }) {
			...
			const [dropBefore, setDropBefore] = (0, import_react.useState)(void 0);
			...
			const endDrag = () => {
				setDragId(void 0);
				setDropBefore(void 0);
			};
			const commitDrop = (event, beforeId) => {
				const transferId = event.dataTransfer.getData("text/plain");
				const draggedId = transferId !== void 0 && transferId !== "" ? transferId : dragId;
				if (draggedId === void 0 || draggedId === beforeId) return;
				const ordered = rebuildOrder(allIdeas, draggedId, "open", beforeId);
				client.reorderIdea(ordered);
				endDrag();
			};
			const dropOnRow = (event, beforeId) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: ranked.map((idea, index) => {
						...
						const isTarget = dragId !== void 0 && dropBefore === idea.id;
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							className: classes.prioritiesRow,
							"data-dsh-idea-id": idea.id,
							"data-drop-target": isTarget ? "" : void 0,
							onDragEnter: () => {
								if (dragId !== void 0) setDropBefore(idea.id);
							},
							onDragOver: (event) => {
								if (dragId !== void 0) {
									event.preventDefault();
		...
		*/
		...
		const BOARD_TABS = ["overview", "priorities"];
		...
		*/
		...
		function IdeasBoard({ client }) {
			...
			const performDrop = async (event) => {
				const transferId = event?.dataTransfer?.getData("text/plain");
				const draggedId = transferId !== void 0 && transferId !== "" ? transferId : drag?.id;
				const target = dragTarget;
				if (draggedId === void 0 || target === void 0 || drag === void 0) return;
				const source = drag.source;
				try {
					if (source !== target.status) if (target.status === "declined") await client.declineIdea(draggedId);
					else await client.moveIdea(draggedId, target.status);
					const ordered = rebuildOrder(client.snapshot?.ideas ?? [], draggedId, target.status, target.beforeId);
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PrioritiesView, {
						client,
