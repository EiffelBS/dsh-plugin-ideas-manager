	...
	factory: (require) => {
		...
		*/
		const fr = {
			...
			"delivered.hint": "Journal des idées livrées — datées et archivées par le verbe deliver",
			"delivered.empty": "Aucune idée livrée pour l’instant",
		...
		const DICTIONARIES = {
			...
			en: {
				...
				"delivered.hint": "Delivered ideas log — date-stamped and archived by the deliver verb",
...
`;
		...
		*/
		function deliveredIdeasOf(ideas, workspaceId) {
			return ideas.filter((idea) => idea.status === "archived" && idea.deliveredAt !== void 0 && (workspaceId === "" || idea.workspaceId === workspaceId));
		}
		//#endregion
		...
		*/
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												idea.value !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: classes.score,
													children: t("card.value", { level: t(levelLabelKey(idea.value)) })
												}),
												idea.effort !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
													className: classes.score,
													children: t("card.effort", { level: t(levelLabelKey(idea.effort)) })
												})
											]
										}),
		...
		function deliveredFirst(ideas) {
			return [...ideas].sort((a, b) => (b.deliveredAt ?? 0) - (a.deliveredAt ?? 0));
		}
		function DeliveredView({ client, deliveredIdeas, workspaceTitle, onEdit, mdMode }) {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					children: rows.map((idea) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: classes.deliveredStamp,
									children: idea.deliveredAt === void 0 ? "" : t("delivered.deliverAt", { date: isoDate(idea.deliveredAt) })
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: classes.prioritiesGrow,
									children: [
											...
											return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												...
												children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
													...
													children: [
														...
														idea.deliveredAt !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
															className: classes.cardMeta,
															children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
														...
														(idea.value !== void 0 || idea.effort !== void 0) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
															className: classes.cardMeta,
															children: [idea.value !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																className: classes.score,
																children: t("card.value", { level: t(levelLabelKey(idea.value)) })
															}), idea.effort !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
																className: classes.score,
