...
`;
		...
		*  label), with null for a workspace that has no registry title. */
		...
		function PrioritiesView({ client, openIdeas, allIdeas, workspaceTitle, onEdit, mdMode, grouped }) {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: `${classes.fieldRow} ${classes.bodyLevelRow}`,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								className: classes.bodyLevelSide,
		...
		*/
		...
		function IdeasBoard({ client }) {
			...
			const scopedOpen = ideas.filter((idea) => idea.status === "open" && matchesWorkspaceScope(idea, workspaceFilter));
...
- When you use PowerShell against the channel, send each JSON body as UTF-8 bytes ([Text.Encoding]::UTF8.GetBytes(...)) so accents survive the round-trip.`;
		...
		*/
		const inject = [WORKSPACES_SERVICE, SESSIONS_SERVICE$1];
		let claimed = false;
		const releaseClaim = () => {
			claimed = false;
		};
