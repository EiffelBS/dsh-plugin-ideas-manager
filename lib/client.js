		...
		function IdeaModal({ client, initial, initialWorkspace, onClose, onFollowUp }) {
			...
			(0, import_react.useEffect)(() => {
				...
				client.sessionLauncher.listModels().then((choices) => {
					...
					client.sessionLauncher.currentModel().then((selection) => {
						if (cancelled) return;
			...
			const selectedModel = selModelKey === "" ? void 0 : filteredModelChoices.find((choice) => choice.label === selModelKey) ?? activeProviderChoices.find((choice) => choice.label === selModelKey);
			(0, import_react.useEffect)(() => {
				const onKey = (event) => {
					if (event.key === "Escape") {
						event.stopPropagation();
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
											...
											}), modelProviders.map((provider) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: provider,
												children: provider
											}, provider))]
										}),
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("select", {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: "",
												children: t("new.modelSessionDefault")
											}), filteredModelChoices.map((choice) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", {
												value: choice.label,
