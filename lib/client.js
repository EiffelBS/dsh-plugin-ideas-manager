	...
	factory: (require) => {
		...
		*/
		const fr = {
			...
			"settings.cardDensityDesc": "Confortable : espacement actuel. Compacte : paddings et espacements réduits dans les colonnes pour voir plus de cartes à l’écran.",
		...
		const en = {
			...
			"settings.cardDensityDesc": "Comfortable: current spacing. Compact: tighter padding in the columns to see more cards on screen.",
