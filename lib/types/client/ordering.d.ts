 ...
 */
export declare function activityBlockOf(idea: ActivityRankable): 0 | 1 | 2;
/**
 ...
 */
export declare function orderByActivity<T extends RankableIdea & ActivityRankable>(rows: readonly T[]): T[];
/**
 ...
 */
export declare function orderOpenColumn<T extends RankableIdea & ActivityRankable>(rows: readonly T[], grouped: boolean, workspaceTitle: (workspaceId: string) => string, ordering: IdeasOpenOrdering): T[];
/**
