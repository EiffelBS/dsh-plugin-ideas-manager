...
export declare function draggedIdFrom(event: DragEvent<HTMLElement>, fallback: string | undefined): string | undefined;
/** True while the pointer sits in the upper half of `element`. */
export declare function beforeHalf(event: DragEvent<HTMLElement>, element: HTMLElement): boolean;
