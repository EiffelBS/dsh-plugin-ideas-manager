 ...
 * the first poll tick.
 */
export declare const LAUNCHABLE_TASK_STATUSES: readonly string[];
/**
 ...
 */
export declare function canLaunch(idea: LaunchTarget): boolean;
 ...
 */
export declare function modelTargetIdOf(model: ModelChoice | undefined): string | undefined;
/**
 ...
 */
export declare class TaskBoardLaunchBackend implements LaunchBackend {
    private readonly transport;
    readonly id: "taskboard";
     ...
     */
    available(_idea: LaunchTarget): Promise<boolean>;
    launch(idea: LaunchTarget, model?: ModelChoice): Promise<LaunchOutcome>;
}
/**
